...
$requiredFields = "Name,Email,Region";

$defaultText = "Please fill in your information below.";

$errorText = "Uh-Oh! Please check that you have filled in all the required information.";

$successText = "Thanks so much! You'll be hearing from us soon!";
